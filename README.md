...
- Área sobre a Curva Precisão-Revocação de Ham (*Ham Area Under PR Curve*)
- Área sobre a Curva Precisão-Revocação de Spam (*Spam Area Under PR Curve*)
- Área sobre a Curva Característica de Operação do Receptor de Ham (*Ham Area Under ROC Curve*)
- Área sobre a Curva Característica de Operação do Receptor de Spam (*Spam Area Under ROC Curve*)
