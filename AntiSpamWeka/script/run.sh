...
MAX_HEAP_SIZE=12G
MAX_STACK_SIZE=8m
JAR_PATH="~/git/anti-spam-weka/AntiSpamWeka/target/AntiSpamWeka-0.0.1-SNAPSHOT-jar-with-dependencies.jar"
...
for METHOD in "${METHOD[@]}"; do
    ...
    LOG_FILENAME="~/git/anti-spam-weka/AntiSpamWeka/target/${METHOD}.log"
